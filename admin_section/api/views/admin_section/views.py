...
from admin_section.api.serializers import (
    ImprovePositionSerializer, ChangeAdminOrStaffPasswordSerializer
)

from extensions.renderers import CustomJSONRenderer
from admin_section.permissions import IsSuperUser, IsAdminOrStaff
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            if (user.national_id and
                ...
                return Response({'error': "national_id, image, first_name and last_name are required "
                                          "and card_number have to be more than one"},
